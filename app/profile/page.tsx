...
export default function ProfilePage() {
  return (
    <div className="min-h-screen bg-nbl-bg flex flex-col">
      ...
      <main className="flex-1 max-w-screen-xl mx-auto w-full px-4 lg:px-8 pb-28 lg:pb-12 pt-8">
        <div className="max-w-lg lg:max-w-none mx-auto lg:grid lg:grid-cols-[300px_1fr] lg:gap-10 lg:items-start">
          ...
          <div className="flex flex-col items-center lg:items-start gap-4">
            <div className="flex flex-col items-center lg:flex-row lg:items-center gap-4">
              ...
              <div className="text-center lg:text-left">
                <h1 className="text-xl font-black text-nbl-white">Koné Dramane</h1>
            ...
            <div className="w-full grid grid-cols-3 gap-3 mt-2">
              {[
                ...
                <div key={label} className="rounded-2xl bg-nbl-surface border border-nbl-border p-3 text-center">
                  <Icon size={18} className="text-nbl-orange mx-auto mb-1" />
                  <p className="text-xl font-black text-nbl-white">{value}</p>
                  <p className="text-[10px] text-nbl-gray font-semibold tracking-wide">{label}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-6 lg:mt-0 space-y-4">
            <div className="rounded-2xl bg-nbl-surface border border-nbl-border p-4">
              <p className="text-xs font-black tracking-widest uppercase text-nbl-gray mb-3">Équipe favorite</p>
              <div className="flex items-center gap-3">
                ...
                <span className="font-black text-nbl-white">BLKTOP — ABIDJAN</span>
              </div>
            </div>

            <div className="rounded-2xl bg-nbl-surface border border-nbl-border p-4">
              <p className="text-xs font-black tracking-widest uppercase text-nbl-gray mb-3">Paramètres du compte</p>
              <div className="flex items-center justify-between py-2 border-b border-nbl-border">
                ...
                <span className="text-xs text-nbl-orange font-bold">Activées</span>
              </div>
